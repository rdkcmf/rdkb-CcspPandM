 ...
 */
#define NAT_GetParamBoolValue_Custom(hInsContext, ParamName, pBool)  FALSE

#define NAT_SetParamBoolValue_Custom(hInsContext, ParamName, bValue) FALSE

#define PortMapping_GetParamUlongValue_Custom(hInsContext, ParamName, puLong)   FALSE

#define PortMapping_SetParamUlongValue_Custom(hInsContext, ParamName, uValue)   FALSE
