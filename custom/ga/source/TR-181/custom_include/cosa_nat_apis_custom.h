...
#define  COSA_DML_NAT_CUSTOM_GET_ENABLEPORTMAPPING(structure)			0
#define  COSA_DML_NAT_CUSTOM_SET_ENABLEHSPORTMAPPING(structure, value)	
#define  COSA_DML_NAT_CUSTOM_GET_ENABLEHSPORTMAPPING(structure)			0
#define  COSA_DML_NAT_CUSTOM_SET_ENABLENATMAPPING(structure, value)
#define COSA_DML_NAT_CUSTOM_GET_ENABLENATMAPPING(structure)				0
